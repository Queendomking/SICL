		...
		<a-row :span="24"
			...
			<a-col :span="6"
              ...
              <a-select-option value="Yiminghe">
                本周
						...
						<a-range-picker class="span_title_select"
														size="small"
					...
					<div style="margin-top:20px">
						<div style="display:inline-block;float:right">
							<div
									 style="height:14px;width:30px;background:linear-gradient(#FFC858, #FDAD51);display:inline-block;margin-right:10px">
							</div>
							<span style="display:inline-block;margin-right:10px">出</span>
							<div
									 style="height:14px;width:30px;background:linear-gradient(#60A4DE, #21BEA2);display:inline-block;margin-right:10px">
							</div>
			...
			<a-col :span="11"
				...
				<div class="one bottom_margin">
					...
					<div class="span_hx"></div>
					<div>
						<div style="height:200px;width:240px;display:inline-block;float:left"
								 id="pbdtj"></div>
						<div style="width:492px;display:inline-block;margin-top:10px"
								 class="one_two_table">
							<a-table bordered
											 :columns="columns1"
											 :data-source="data1"
								...
								<template v-slot:action>
									<a @click="showPModal_pbdtj"
										 style="color:#22BDA4">查看</a>
								</template>
							</a-table>
						</div>
						<!-- 配变电物料统计隐藏模块 -->
						<a-modal title="配变电物料统计"
										 :visible="visible_pbdtj"
										 :confirm-loading="confirmLoading"
										 @ok="handleOk"
										 @cancel="handleCancel_pbdtj">
							<a-table :loadin="!xlUpdateData"
											 id="pbdmk"
											 bordered
											 :columns="columns_pbd"
											 :pagination="false"
											 :data-source="data_colum_pbd"
											 :scroll="{ y: 240 }">
								<template v-slot:action>
									<a @click="showPModal_pbdtj"
										 style="color:#22BDA4">查看</a>
				...
				<div class="two">
					...
					<div>
						<div style="height:200px;width:240px;display:inline-block;float:left"
								 id="xptjtb"></div>
						<div style="width:8.75rem;display:inline-block;margin-top:10px"
								 class="two_two_table">
							<a-table bordered
											 :columns="columns1"
											 ...
											 :pagination="{'item-render': itemRender}">
								<template v-slot:action>
									<a @click="showPModal_xptj"
										 style="color:#22BDA4">查看</a>
								</template>
							</a-table>

							<!-- 新品物料统计隐藏模块 -->
							<a-modal title="新品物料统计"
			...
			<a-col :span="7"
				...
				<div class="two">
					...
					<div style="height:auto">
						<div style="height:260px;width:260px;display:inline-block;float:left"
								 id="dltj"></div>
		...
		<a-row class="two"
			...
			<a-col class="two_one"
				...
				<div class="one">
					...
					<div class="span_hx"></div>
					<div>
						<div style="height:260px;margin-top:35px"
								 id="ckrj"></div>
					</div>
				</div>
			</a-col>
			<a-col class="two_two"
				...
				<div class="one">
					<div class="span_title">
						...
						<a-range-picker class="span_title_span"
														size="small"
														@change="xltjTimeChange"
...
export default {
	...
	methods: {
		...
		showPModal_pbdtj() {
			...
			;(this.xlUpdateData = true),
				...
				(this.dsq = setInterval(() => {
					var boxHeight = document
						.getElementById('pbdmk')
						.getElementsByClassName('ant-table-scroll')[0]
						.getElementsByClassName('ant-table-body')[0].clientHeight
					var boxAllHeight = document
						.getElementById('pbdmk')
						.getElementsByClassName('ant-table-scroll')[0]
					...
					var scrollTop = document
						.getElementById('pbdmk')
						.getElementsByClassName('ant-table-scroll')[0]
						.getElementsByClassName('ant-table-body')[0].scrollTop
		...
		bptj() {
			...
			getAction('/index/getBTPJList', req)
				.then((res) => {
					...
					_this.bptj_chart.facet('mirror', {
						...
						eachView: (view, facet) => {
							...
							if (facetIndex === 0) {
								view.interval().position('country*value').color(color).size(18)
							} else {
								view.interval().position('country*value').color(color).size(18)
							}
						},
		...
		xltj() {
			...
			getAction('/index/getXLTJList', req)
				.then((res) => {
		...
		lctj() {
			...
			getAction('/index/getLCTJList', req)
				.then((res) => {
